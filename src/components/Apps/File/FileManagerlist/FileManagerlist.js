    ...
    <Row>
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card border p-0 shadow-none">
          <Card.Body className="text-center">
            <div className="file-manger-icon">
              <Link to path={`/apps/file/filedetails`}>
                <img
                  src={require("../../../../assets/img/files/doc.png")}
                  alt="img"
                  className="br-7"
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-1.jpg")}
              alt="img"
            />
          </Link>
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-2.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-3.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-4.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/Filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-5.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/Filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-6.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
      ...
      <Col xl={2} md={3} lg={6}>
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/Filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-7.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
      ...
      <div className="col-xl-2  col-md-3  col-lg-6">
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/Filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-8.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
      ...
      <div className="col-xl-2  col-md-3 col-lg-6">
        <Card className="custom-card overflow-hidden">
          <Link to={`/apps/file/filedetails`}>
            <img
              src={require("../../../../assets/img/files/img-9.jpg")}
              alt="img"
            />
          </Link>
          <div className="card-footer bd-t-0 py-3">
