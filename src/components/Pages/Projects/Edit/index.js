...
import { useEditProject } from "../../../../Api/Projects";
...
const EditeProjects = ({ id, itemData, viewDemoClose }) => {
  const { mutate, data } = useEditProject();
  console.log(data);
...
EditeProjects.propTypes = {};

EditeProjects.defaultProps = {};

export default EditeProjects;
